...
export function getDailyForcedWaveSpecies(waveIndex: number): PokemonSpecies | null {
  ...
  if (!isGeneratedRosterSpeciesId(forcedWave.speciesId)) {
    console.warn("Blocked custom daily run forced wave species outside generated roster:", forcedWave.speciesId);
    return null;
  }
