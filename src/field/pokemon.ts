...
export abstract class Pokemon extends Phaser.GameObjects.Container {
  ...
  /** Debug preview escape hatch; normal gameplay keeps the generated-roster evolution guard. */
  public allowUnrosteredEvolution = false;
      ...
      this.fusionSpecies =
        dataSource.fusionSpecies instanceof PokemonSpecies
          ...
          : dataSource.fusionSpecies
            ...
            : null;
      if (this.fusionSpecies && !isGeneratedRosterSpeciesId(this.fusionSpecies.speciesId)) {
        console.warn(
          `Blocked fused species ${SpeciesId[this.fusionSpecies.speciesId] ?? this.fusionSpecies.speciesId} outside generated roster.`,
        );
...
export class PlayerPokemon extends Pokemon {
  ...
  getPossibleEvolution(evolution: SpeciesFormEvolution | null): Promise<Pokemon> {
    if (!evolution || (!this.allowUnrosteredEvolution && !isGeneratedRosterSpeciesId(evolution.speciesId))) {
  ...
  evolve(evolution: SpeciesFormEvolution | null, preEvolution: PokemonSpeciesForm): Promise<void> {
    ...
    if (!this.allowUnrosteredEvolution && !isGeneratedRosterSpeciesId(evolution.speciesId)) {
      console.warn(
        `Blocked evolution ${SpeciesId[evolution.speciesId] ?? evolution.speciesId} outside generated roster.`,
      );
      return new Promise(resolve => resolve());
    }
    return new Promise(resolve => {
