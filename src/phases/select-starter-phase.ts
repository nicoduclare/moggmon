...
import { GENERATED_STARTER_SPECIES, GENERATED_STARTER_SPECIES_SET } from "#constants/generated-starter-species";
...
export class SelectStarterPhase extends Phase {
  ...
  initBattle(starters: Starter[]) {
    ...
    starters.forEach((starter: Starter, i: number) => {
      ...
      if (!GENERATED_STARTER_SPECIES_SET.has(starter.speciesId)) {
        console.warn(`Blocked starter species outside generated starter roster: ${starter.speciesId}`);
        starter.speciesId = GENERATED_STARTER_SPECIES[0]!;
        starter.formIndex = 0;
      }
