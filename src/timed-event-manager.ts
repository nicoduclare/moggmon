...
import { isApp, isDev } from "#constants/app-constants";
...
export class TimedEventManager {
  ...
  public getEventPokemonSpriteReplacement(
    ...
    // Mogger Mon's standalone app build uses custom installed species art and
    // should not be randomized by upstream timed-event sprite replacements.
    if (isApp || isDev) {
      return null;
    }
