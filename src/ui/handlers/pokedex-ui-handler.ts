...
export class PokedexUiHandler extends MessageUiHandler {
  ...
  private pokemonLoadingText: Phaser.GameObjects.Text;
  ...
  setup() {
    ...
    this.pokemonLoadingText = addTextObject(96, 142, i18next.t("menu:loading"), TextStyle.INSTRUCTIONS_TEXT, {
      fontSize: textSettings.instructionTextSize,
    });
    this.pokemonLoadingText.setOrigin(0.5, 0.5);
    this.pokemonLoadingText.setVisible(false);
    this.starterSelectContainer.add(this.pokemonLoadingText);
  ...
  setSpeciesDetails(species: PokemonSpecies, options: SpeciesDetails = {}): void {
    ...
    if (species) {
      ...
      if (shouldUpdateSprite) {
        this.pokemonLoadingText.setVisible(!(this.filterMode || this.filterTextMode));
