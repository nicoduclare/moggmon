...
const config = {
  ...
  customFooterHtml: `<p>Copyright <strong>Mogger Mon contributors</strong> ${new Date().getFullYear()}</p>`,
  customFooterHtmlDisableWrapper: true,
  navigationLinks: {
    GitHub: "https://github.com/auramaxx/mogger-mon",
  },
...
if (!dryRun && process.env.REF_NAME) {
  ...
  config.navigationLinks = {
    ...
    [`Switch to ${otherRefName.charAt(0).toUpperCase() + otherRefName.slice(1).toLowerCase()}`]: `https://moggermon.gg/docs/${otherRefName}`,
  };
}
